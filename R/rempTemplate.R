...
#' 
#' @return A \code{list} object containing a \code{\link{GRanges}} object of neifhboring CpGs of RE-CpGs 
...
#' and a string of methylation platform (\code{$arrayType}).
#' 
#' @examples
...
rempTemplate <- function(methyDat = NULL, remparcel = NULL, win = 1000, verbose = FALSE)
{
  ...
  res <- list(NBCpG_methyDat = DataFrame(methyDat), RECpG_methyDat = DataFrame(RE_CpG_ILMN_DATA), 
