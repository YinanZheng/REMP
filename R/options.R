...
REMPOPTIONS <- options_manager(
  .default.AluFamily = c("AluJb", "AluJo", "AluJr", "AluJr4", "AluSc", "AluSc5", 
  ...
  .default.L1Family = c("L1MC5a", "L1MB3", "L1MB5", "L1PA6", "L1P1", "L1MA8", 
  ...
  .default.genomicRegionColNames = c("InNM", "InNR", "InTSS", "In5UTR", 
                                     "InCDS", "InExon", "In3UTR"),
  
  .default.predictors = c("RE.score", "RE.Length", "RE.CpG.density", "RE.InNM", 
                          "RE.InNR", "RE.InTSS", "RE.In5UTR", "RE.InCDS", "RE.InExon", "RE.In3UTR", 
...
#'  \item{\code{.default.C.svmRadial.tune}}{Define the default \code{C} (Cost) parameter for SVM
#'  using Radial basis function kernel.} 
#' }
#' 
#' @return \code{NULL}
